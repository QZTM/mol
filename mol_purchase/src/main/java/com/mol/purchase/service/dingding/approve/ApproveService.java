...
import com.mol.purchase.mapper.newMysql.dingding.approve.ApproveMapper;
import com.mol.purchase.service.token.TokenService;
import entity.ServiceResult;
import entity.ServiceResultCode;
...
//            request.setCcPosition("FINISH");
            ...
            OapiProcessinstanceCreateResponse response = client.execute(request, tokenService.getToken());
