...
public class Alipay {
    ...
    public static Alipay getAlipay(String orderId,String body,String subject,String timeoutExpress,String callbackUrl,String totalAmount,String productCode) {
        if (alipay == null) {
            synchronized (Alipay.class) {
                if (alipay == null) {
