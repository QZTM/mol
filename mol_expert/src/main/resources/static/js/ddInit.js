...
//                         //鉴权
//                         dd.config({
//                                         'agentId': JSON.stringify(b.result.agentId),
//                                         'corpId': JSON.stringify(b.result.corpId),
//                                         'timeStamp': JSON.stringify(b.result.timeStamp),
//                                         'nonceStr': JSON.stringify(b.result.nonceStr),
//                                         'signature': JSON.stringify(b.result.signature),
//                                         'jsApiList': [
//                                             'runtime.info',
