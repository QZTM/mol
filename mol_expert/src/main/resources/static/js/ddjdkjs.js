        ...
        return function(e) {
            ...
            function(e, t, n) {
                ...
                t.getUA = function() {
                    ...
                    t.getENV = function() {
                        var e = t.getUA(),
                            n = /DingTalk/i.test(e) || i.
                                default.isDingTalk,
                            o = /iPhone|iPad|iPod|iOS/i.test(e) && n || i.
                                default.isWeexiOS,
                            a = /Android/i.test(e) && n || i.
                                default.isWeexAndroid,
                            s = /Nebula/i.test(e) && n || "object" == typeof dd && "function" == typeof dd.dtBridge,
                            d = /dd-web/i.test(e),
                            u = r.APP_TYPE.WEB;
                        d ? u = r.APP_TYPE.WEBVIEW_IN_MINIAPP: s ? u = r.APP_TYPE.MINI_APP: (i.
                            default.isWeexiOS || i.
                            default.isWeexAndroid) && (u = r.APP_TYPE.WEEX);
                        var c, l = "*",
                        ...
                        if ("undefined" != typeof name && (p = name), p) try {
                            var _ = JSON.parse(p);
                            _.hostVersion && (v = _.hostVersion),
                                l = _.language || navigator.language || "*",
                                c = _.containerId
                        } catch(e) {}
                        var E, N = !!c;
            ...
            function(e, t, n) {
                ...
                var r = n(175);
                t.APP_TYPE = r.APP_TYPE,
                    t.LogLevel = r.LogLevel,
                    t.isFunction = r.isFunction,
                    t.compareVersion = r.compareVersion,
                    ...
                    function e(e, t) {
                        ...
                        this.configJsApiList = [],
                            ...
                            this.invokeAPI = function(e, t, o) {
                                void 0 === t && (t = {}),
                                void 0 === o && (o = !0),
                                    n.customLog(r.LogLevel.INFO, ['==> "' + e + '" params: ', t]);
                                var i = +new Date,
                                ...
                                !1 === n.devConfig.isAuthApi && (o = !1),
                                    n.bridgeInitFn().then(function(s) {
                                        ...
                                        if (d || !o) {
                                            ...
                                            if (d && (c = d[n.env.platform]), c || !o) {
                                                var l = {};
                                                l = !u && c && c.paramsDeal && r.isFunction(c.paramsDeal) ? c.paramsDeal(t) : Object.assign({},
                                                    t);
                                                var f = function(e) {
                                                ...
                                                return s(e, l).then(f,
                                                    function(t) {
                                                        ...
                                                        return n.devConfig.onAfterInvokeAPI && n.devConfig.onAfterInvokeAPI({
                                                            ...
                                                            n.customLog(r.LogLevel.INFO, ['<== "' + e + '" success result: ', o]),
                                                            o
                                                    },
                                                    function(o) {
                                                        return n.devConfig.onAfterInvokeAPI && n.devConfig.onAfterInvokeAPI({
                                                            ...
                                                            n.customLog(r.LogLevel.WARNING, ['<== "' + e + '" fail result: ', o]),
                                                            Promise.reject(o)
                                                    })
                                            }
                                            var p = '"' + e + '" do not support the current platform (' + n.env.platform + ")";
                                            return n.customLog(r.LogLevel.ERROR, [p]),
                                                Promise.reject({
                            ...
                            this.bridgeInitFn = function() {
                                ...
                                if (t) n.bridgeInitFnPromise = t.bridgeInit().
                                    ...
                                    n.customLog(r.LogLevel.WARNING, [o]),
                                        n.bridgeInitFnPromise = Promise.reject(new Error(o))
                                }
                        ...
                        this.exportSdk = {
                            config: function(t) {
                                void 0 === t && (t = {});
                                var i = !0;
                                Object.keys(t).forEach(function(e) { - 1 === ["debug", "usePromise"].indexOf(e) && (i = !1)
                                }),
                            ...
                            devConfig: o,
                            ready: function(e) { ! 1 === n.hadConfig ? (n.customLog(r.LogLevel.WARNING, ["You don 't use a dd.config, so you don't need to wrap dd.ready, recommend remove dd.ready"]), n.bridgeInitFn().then(function() {
                                e()
                ...
                function() {
                    return function(e) {
                        ...
                        572 : function(e, t, n) { (function(e, n) {
                            ...
                            function C(e, t) {
                                var n = this.__data__;
                                return n instanceof h && n.__data__.length == Ae && (n = this.__data__ = new g(n.__data__)),
                                    n.set(e, t),
                                    this
                            }
                            function T(e, t, n) {
                            ...
                            var Ae = 200,
                                ...
                                nt = /^(?:0|[1-9]\d*)$/,
                                rt = {};
                            rt[Ue] = rt["[object Array]"] = rt[Le] = rt[ze] = rt[Oe] = rt[je] = rt[Be] = rt[qe] = rt[Ye] = rt[Je] = rt[Ge] = rt[De] = rt[Ce] = rt[Te] = rt[xe] = rt[Fe] = rt[Re] = rt[We] = rt[He] = rt[Ke] = rt[Xe] = rt[Qe] = !0,
                            ...
                            function r(e, t) {
                                return t = y(void 0 === t ? e.length - 1 : t, 0),
                                    function() {
                                        for (var r = arguments,
                                                 o = -1,
                                                 i = y(r.length - t, 0), a = Array(i); ++o < i;) a[o] = r[t + o];
                                        o = -1;
